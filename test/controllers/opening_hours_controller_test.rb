...
class OpeningHoursControllerTest < ActionController::TestCase
  ...
  test "should create opening_hour" do
    assert_difference('OpeningHour.count') do
      post :create, opening_hour: { closing_time: @opening_hour.closing_time, day: @opening_hour.day, opening_time: @opening_hour.opening_time, supperplace_id: @opening_hour.supperplace_id }
    end
  ...
  test "should update opening_hour" do
    patch :update, id: @opening_hour, opening_hour: { closing_time: @opening_hour.closing_time, day: @opening_hour.day, opening_time: @opening_hour.opening_time, supperplace_id: @opening_hour.supperplace_id }
    assert_redirected_to opening_hour_path(assigns(:opening_hour))
  end
